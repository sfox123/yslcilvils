...
const footer_contents = {
  title: <>Experts in Groundworks, Concrete Frames, and Civil Engineering. Tailored construction solutions for every client. 🤝</>,
  btn_text: 'Contact Us',
  copyRight_text: <>© {new Date().getFullYear()} Shara Solutions , All Right Recieved.</>,
          ...
          <div className="tp-footer-widget wow tpfadeUp" data-wow-duration=".5s" data-wow-delay=".5s">
            <div className="row align-items-center">
              <div className="col-xl-7 col-lg-7 col-md-7 col-12">
                ...
                <div className="tp-footer-top">
                  <h6 className="mt-4 tp-footer-sub-title">{'Opening Hours - 8:00 AM - 17:30 PM (MON - SAT)'}</h6>
                </div>
              </div>

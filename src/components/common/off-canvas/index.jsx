      ...
      <div className="tp-offcanvas-area">
        <div className={`tpoffcanvas ${isOpen ? 'opened' : ''}`}>
          ...
          <div className="tpoffcanvas__contact">
            ...
            <ul>
              <li>
                <i className="fas fa-star"></i> <a href="https://goo.gl/maps/abHegV4AoiJA6Syd8" rel="noreferrer" target="_blank">15 Meadow Croft HATFIELD AL10 0SG</a>
              </li>
              <li><i className="fas fa-star"></i><a href="tel:8180012345678">07929 363732</a></li>
              <li><i className="fas fa-star"></i><a href="mailto:Collaxmail@gmail.com">info@yslcivils.co.uk</a></li>
            </ul>
          </div>
